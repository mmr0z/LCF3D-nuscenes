...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/mnt/proj2/dd-24-8/frustum_datasets/nuscenes_v2_all_classes/nusc_frustum_info_val.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        metainfo=dict(classes=[
            'car',
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            ann_file=
            '/mnt/proj2/dd-24-8/frustum_datasets/nuscenes_v3_all_classes/nusc_frustum_info_train.pkl',
            backend_args=None,
            box_type_3d='LiDAR',
            metainfo=dict(classes=[
                'car',
...
work_dir = '/mnt/proj2/dd-24-8/mmdetection_work_dir/frustum_pointnet_nuscenes_gaussian_likelihood_all_classes'
