...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/mnt/proj2/dd-24-8/frustum_datasets/v1_single_view/kitti_frustum_info_val.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        metainfo=dict(classes=[
            'Pedestrian',
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            ann_file=
            '/mnt/proj2/dd-24-8/frustum_datasets/v1_single_view/kitti_frustum_info_train.pkl',
            backend_args=None,
            box_type_3d='LiDAR',
            metainfo=dict(classes=[
                'Pedestrian',
...
work_dir = '/mnt/proj2/dd-24-8/mmdetection_work_dir/frustum_pointnet_single_view'
