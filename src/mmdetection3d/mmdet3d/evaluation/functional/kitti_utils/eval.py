...
def kitti_eval(gt_annos,
               ...
               current_classes,
               eval_types=['bbox', 'bev', '3d'],
               strict_overlaps=[[0.7, 0.5, 0.5, 0.7, 0.5], 
                                [0.7, 0.5, 0.5, 0.7, 0.5],
                                [0.7, 0.5, 0.5, 0.7, 0.5]],
               loose_overlaps=[[0.7, 0.5, 0.5, 0.7, 0.5],
    ...
    min_overlaps = np.stack([np.array(strict_overlaps), np.array(loose_overlaps)], axis=0)   
    ...
    for anno in gt_annos:
        if anno['alpha'].shape[0] > 0 and anno['alpha'][0] != -10:
            valid_alpha_gt = True
            break
